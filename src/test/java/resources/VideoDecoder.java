...
public class VideoDecoder {
	...
	public CreateDecoder createDolbyDecoderPayload(String parent, String displayName, String vendor, String decoderIdentifier,
			String supportedChannelVendor) {
		CreateDecoder decoder = new CreateDecoder();
		decoder.setParent(parent);
		DisplayName name = new DisplayName();
        name.setValue(displayName);
        decoder.setDisplay_name(name);
        decoder.setVendor(vendor);
        decoder.setVendor_decoder_identifier(decoderIdentifier);
        decoder.setSupported_channel_vendor(supportedChannelVendor);
